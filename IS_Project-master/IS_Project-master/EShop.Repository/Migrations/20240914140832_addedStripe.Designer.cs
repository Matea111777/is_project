...
namespace EShop.Repository.Migrations
{
    ...
    [Migration("20240914140832_addedStripe")]
    partial class addedStripe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Domain.Domain.BooksInOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EShop.Domain.Domain.BooksInOrder", b =>
                {
                    b.HasOne("EShop.Domain.Domain.Book", "OrderedProduct")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
